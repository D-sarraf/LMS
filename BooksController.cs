...
namespace LMS.Controllers
{
    public class BooksController : Controller
    {
        ...
        public BooksController(LDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create(Book mybook)
        {
            ...
            if (mybook.CoverImage != null)
            {
                ...
                string fileName = Guid.NewGuid().ToString() + Path.GetExtension(mybook.CoverImage.FileName);
        ...
        {
            var books = _context.Books.Include(b => b.BorrowRecords).AsQueryable();
